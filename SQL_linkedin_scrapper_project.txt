...
---1st Comparison of number of jobs across different cities for different level 
...
---2nd Generate some insight with respect to number of jobs distribution across various industry
...
---3rd Generate insights into number of opening with respect to the current employee count
...
---4th Count the number of jobs across different industry across different locations
